...
def Send_Cube(name="default",pos=[0,0,0],size=[1,1,1], color_string='    <color rgba="0 1.0 1.0 1.0"/>', color_name="Cyan"):
    ...
    if filetype == SDF_FILETYPE:
        ...
        link = LINK_URDF(name,pos,size, color_string, color_name)
